<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <!-- Phone -->
        <div>
            <x-input-label for="phone" :value="__('Phone number')" class="font-semibold text-gray-900" />
            <div class="flex mt-2">
        ...
        <!-- Confirm Password -->
        <div>
            <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="font-semibold text-gray-900" />
            <div class="relative">
                <x-text-input 
