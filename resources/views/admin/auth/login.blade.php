    ...
    <div class="w-100" style="max-width: 28rem;">
        <div class="bg-white rounded-4 shadow-lg p-4 p-md-5">
            <div class="text-center mb-4">
                <x-shield-logo class="text-dark mx-auto d-block" style="width: 4rem; height: 4rem;" />
            </div>

            <h2 class="h3 fw-bold text-center text-dark mb-2">Admin Login</h2>
            <p class="text-secondary text-center mb-4">Access the admin dashboard</p>
            ...
            <form method="POST" action="{{ route('admin.login') }}" autocomplete="off">
                ...
                <div class="mb-3">
                    ...
                    <input id="username" class="form-control @error('username') is-invalid @enderror" type="text" name="username" value="{{ old('username', 'Admin') }}" placeholder="Admin" required autofocus autocomplete="off" />
                    @error('username')
