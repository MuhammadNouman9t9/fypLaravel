<x-landing-layout title="Home">
    <section class="landing-hero-section bg-gradient-purple overflow-hidden d-flex align-items-center">
        <div class="container py-4 py-md-5">
            <div class="row align-items-center g-4 g-lg-5">
                <div class="col-lg-6 text-white position-relative text-center text-lg-start" style="z-index: 1;">
                    ...
                    <h1 class="display-4 fw-bold lh-sm mb-3 mb-md-4">
                    ...
                    <p class="lead text-purple-soft mb-3 mb-md-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-lg-start gap-3 gap-md-4 flex-wrap">
                ...
                <div class="col-lg-6 d-flex justify-content-center justify-content-lg-end">
                    <div class="w-100 hero-visual-wrap">
                        <div class="bg-white bg-opacity-10 border border-white border-opacity-25 rounded-4 p-4 p-md-5 shadow-lg">
